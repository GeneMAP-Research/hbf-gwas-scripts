...
PROCESS  /mnt/lustre/groups/CBBI1243/KEVIN/gwasdata/cam_tz_merge/meta_analysis/input/cm_${imp}.assoc
...
PROCESS  /mnt/lustre/groups/CBBI1243/KEVIN/gwasdata/cam_tz_merge/meta_analysis/input/tz_${imp}.assoc

OUTFILE   /mnt/lustre/groups/CBBI1243/KEVIN/gwasdata/cam_tz_merge/meta_analysis/output/cm_tz_${imp}_metaanalysis .tbl
LOGPVALUE   OFF
ANALYZE   HETEROGENEITY
QUIT""" > ${imp}_metaljob.txt
fi
